...
frappe.views.CalendarView = class CalendarView extends frappe.views.ListView {
	...
	get required_libs() {
		let assets = [
			'assets/healthcare_doworks/js/lib/fullcalendar/fullcalendar.min.css',
			'assets/healthcare_doworks/js/lib/fullcalendar/scheduler.min.css',
			'assets/healthcare_doworks/js/lib/fullcalendar/fullcalendar.min.js',
			'assets/healthcare_doworks/js/lib/fullcalendar/scheduler.min.js',
			'assets/healthcare_doworks/js/lib/fullcalendar/locale-all.js',
		];
