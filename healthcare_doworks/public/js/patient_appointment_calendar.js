...
frappe.views.calendar["Patient Appointment"] = {
                ...
                element.bind('mousedown', function (e) {
                    if (e.which == 3) {
                        ...
                        frappe.call({
                            ...
                            callback: function (r) {
                                //frappe.set_route('patient_profile?patient=' + r.message.patient); 
                                // frappe.set_route('patient_profile', r.message.patient);
                                frappe.set_route('Form', 'Patient Appointment', event.name);
                                // frappe.set_route('Form', 'Patient', r.message.patient);
                                // TODO: patient profile dialog
                            }
                        });
                    }
                });
    ...
    get_events_method: "healthcare_doworks.api.methods.get_events_full_calendar"
...
function update_waiting_list() {
    frappe.call({
        method: 'healthcare_doworks.api.methods.get_waiting_list',
        callback: function (r) {
...
function render_waiting_list_table(data) {
    if ($('#monthdatepicker').length == 0) {
        ...
        $("div.col-lg-2.layout-side-section").prepend(function () {
